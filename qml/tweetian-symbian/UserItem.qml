...
Item {
    ...
    onScreenNameChanged: {
        ...
        if (user.hasOwnProperty("screenName")){
            console.log("onscren  hasOwn")
            internal.showUserData();
        }
        else if (screenName === settings.userScreenName && cache.userInfo) {
            console.log("onscreen screenName === settings.userScreenName ")
            user = cache.userInfo;
            internal.showUserData();
        }
        else {
            ...
            var msg = {
                      type: "sameUser",
                      model: fullModel,
                      threadModel: userInfoRepeater.model
                  }
    ...
    Component.onCompleted: {
        ...
        console.log("settings userscreaname: " + settings.userScreenName);
        console.log("oncomplete 2")
        console.log("scrren name: " + screenName);
        ...
        if (user.hasOwnProperty("screenName")){
            console.log("oncomplete  hasOwn")
            internal.showUserData();
        }
        else if (screenName === settings.userScreenName && cache.userInfo) {
            console.log("oncomplete screenName === settings.userScreenName ")
            user = cache.userInfo;
            internal.showUserData();
        }
    ...
    Flickable {
        ...
        Column {
            ...
            AboutPageItem {
                imageSource: "Image/ic_settings.png"
                text: qsTr("Settings")
    ...
    WorkerScript {
          id: userParser
          source: "WorkerScript/UserItemParser.js"
    ...
    QtObject {
        ...
        function refresh() {
            console.log("refresh: ");
            console.log("refresh user1: " + userPage.screenName);
            console.log("refresh user2: " + screenName);
        ...
        function userInfoOnFailure(status, statusText) {
            ...
            console.log("status txt: " + statusText);
